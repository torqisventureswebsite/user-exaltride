...
export const metadata = {
  ...
  description: "Handpicked selection of premium car accessories",
};

export default async function FeaturedPage() {
  const products = await fetchFeaturedProducts(200);
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <CollectionPageClient
        ...
        description="Handpicked selection of premium accessories"
