                ...
                >
                  <div className="h-full flex items-center justify-between px-4 md:px-10">
                    ...
                    <div className="max-w-[65%] md:max-w-lg">
                      <h2 className="text-lg md:text-4xl font-bold text-[#001F5F] mb-1 md:mb-2 leading-tight">
                        {slide.title}
                      </h2>
                      <p className="text-xs md:text-lg text-[#001F5F]/80 mb-2 md:mb-4 line-clamp-2">
                        {slide.subtitle}
                      </p>
                    ...
                    {/* RIGHT IMAGE/ICON */}
                    <div className="relative w-[70px] h-[70px] md:w-[160px] md:h-[160px] shrink-0 bg-[#001F5F]/10 rounded-xl md:rounded-2xl flex items-center justify-center">
                      <Tag className="w-8 h-8 md:w-20 md:h-20 text-[#001F5F]" strokeWidth={1.5} />
                    </div>
                  </div>
                </div>
              </CarouselItem>
